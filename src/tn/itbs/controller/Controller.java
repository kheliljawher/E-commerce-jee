	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(page.equals("sign-up-form")) {
			...
			if(password_1.equals(password_2)) {
				...
				request.setAttribute("msg", "Compte créé avec succès, veuillez vous connecter!");
				request.getRequestDispatcher("login.jsp").forward(request, response);
		...
		if(page.equals("login-form")) {
			...
			if(status) {
				...
				request.setAttribute("msg", "Les informations d'identification invalides");
				request.setAttribute("username", username);
				request.getRequestDispatcher("login.jsp").forward(request, response);
			}
		...
		if(page.equals("mobiles") || page.equals("laptops") || page.equals("vetement") || page.equals("home-decor") || page.equals("all-products")) {
			DB db = new DB();
			 try {
				list = db.fetch();
			} catch (SQLException e) {
		...
		if(page.equals("addtocart")) {
			...
			if(check)
				JOptionPane.showMessageDialog(null, "Le produit est déjà ajouté au panier", "Info", JOptionPane.INFORMATION_MESSAGE);
			else {
			cartlist.add(id);
			JOptionPane.showMessageDialog(null, "Produit ajouté avec succès au panier", "Info", JOptionPane.INFORMATION_MESSAGE);
			}
