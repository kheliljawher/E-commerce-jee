	...
	<div class="signup-header">
	 ...
	 <input type="hidden" name="page" value="login-form">
	 	...
	 	<div class="signup-group">
	 		...
	 		<input type="text" name="username" placeholder="votre Username" value="<c:out value="${username }"></c:out>" required="required">
	 	</div>
	 	<div class="signup-group">
	 	...
	 	<p>
	 		Nouveau sur E_Boutique? <a href="Controller?page=sign-up" style="color:#F24638;">Créer un compte</a>
	 	</p>
	 </form>
	<br><br><br>
