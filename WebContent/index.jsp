 	...
 	<div class="container">
 		<div class="row">
 				...
 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Produits Populaires</h2><br>
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getFeatured() == 'yes' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=index&id=<c:out value="${product.getId()}"/>">Ajouter au panier</a> </div><br>
		 					</div>
